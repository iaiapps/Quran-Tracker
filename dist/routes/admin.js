...
admin.get("/", (c) => {
    ...
    return c.html(_jsx(AdminPage, { user: user, pendingUsers: pendingUsers, allUsers: allUsers, targetKhatam: targetKhatam, ramadanYear: ramadanYear, success: success, error: error }));
});
