...
leaderboard.get("/", (c) => {
    ...
    return c.html(_jsx(LeaderboardPage, { user: user, topThree: allTop, members: members, currentUserRank: currentUserRank, page: page, totalMembers: total, perPage: perPage, search: search, sort: sort }));
});
