...
dashboard.get("/", (c) => {
    ...
    return c.html(_jsx(DashboardPage, { user: user, cycle: userProgress.cycle, target: userProgress.target, progressPercent: userProgress.progressPercent, totalMemorized: userProgress.totalMemorized, rank: rank, currentPosition: userProgress.currentPosition, ramadanYear: ramadanYear }));
});
